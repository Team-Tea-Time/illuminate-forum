...
@section('content')
    <div class="panel panel-default">
        <div class="panel-heading">{{ trans('firefly::discussions.create') }}</div>
        ...
        <div class="panel-body">
            <form action="{{ route('forum.discussions.store') }}" method="POST">
                ...
                <div class="form-group{{ $errors->has('group_id') ? ' has-error' : '' }}">
                    <label for="group_id">{{ trans('firefly::groups.singular') }}</label>
                    @include('firefly::partials.group-select')
